...
$page_title = 'Pending Payments - ' . APP_NAME;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="pending.php" class="nav-item nav-link active">Pending Payments</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h1 class="text-white">Pending Payments</h1>
                    <p class="text-white mb-0">Review completed payments and activate enrollments.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <?php if (empty($paymentsData['payments'])): ?>
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">No completed payments are waiting for verification right now.</p>
                                ...
                                <tbody>
                                    <?php foreach ($paymentsData['payments'] as $payment): ?>
                                        <tr>
                                            ...
                                            <td><strong><?php echo htmlspecialchars($payment['course_title']); ?></strong></td>
                                                ...
                                                <div class="modal-content">
                                                    <form method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Verify payment for <strong><?php echo htmlspecialchars($payment['student_name']); ?></strong> in <strong><?php echo htmlspecialchars($payment['course_title']); ?></strong>?</p>
                                                            ...
                                                            <p class="text-success">The student will be notified and their enrollment will be activated.</p>
                                                        </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Reject payment for <strong><?php echo htmlspecialchars($payment['student_name']); ?></strong> in <strong><?php echo htmlspecialchars($payment['course_title']); ?></strong>?</p>
                                                            <div class="mb-3">
