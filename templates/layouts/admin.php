...
<head>
    <meta charset="utf-8">
    <title><?php echo $page_title ?? APP_NAME; ?> - Admin Portal</title>
                ...
                <div class="sidebar p-3">
                    <div class="text-center mb-4">
                        <div class="bg-primary rounded-circle d-inline-flex align-items-center justify-content-center mb-2" style="width: 50px; height: 50px;">
                            <i class="fa fa-user-shield fa-2x text-white"></i>
                        </div>
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link" href="<?php echo BASE_URL; ?>/admin/instructors/applications.php">
                            <i class="fa fa-user-plus"></i> Applications
                        </a>
                        <a class="nav-link" href="<?php echo BASE_URL; ?>/admin/courses/pending.php">
                            <i class="fa fa-clock"></i> Pending Courses
                        </a>
                        <a class="nav-link" href="<?php echo BASE_URL; ?>/admin/courses/approved.php">
                            <i class="fa fa-check-circle"></i> Approved Courses
                        </a>
                        <a class="nav-link" href="<?php echo BASE_URL; ?>/admin/enrollments/pending.php">
                            <i class="fa fa-credit-card"></i> Pending Enrollments
                        </a>
                        <a class="nav-link" href="<?php echo BASE_URL; ?>/admin/enrollments/list.php">
                            <i class="fa fa-list"></i> All Enrollments
                        </a>
                        <a class="nav-link" href="<?php echo BASE_URL; ?>/admin/settings/index.php">
